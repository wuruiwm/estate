...
-- ----------------------------
INSERT INTO `tplay_admin` VALUES (1, 'Tplay', 'admin', '972262e4efe2e00f364d979a7c6ae7ee', 2, 1510885948, 1544087338, 1544090339, '127.0.0.1', 1);
...
-- ----------------------------
INSERT INTO `tplay_banner` VALUES (3, 74, 'http://baidu.con', 1, 2, NULL, 1540259936, 1540275403);
INSERT INTO `tplay_banner` VALUES (4, 75, 'http://baidu.con', 1, 1, NULL, 1540264078, 1540282033);
INSERT INTO `tplay_banner` VALUES (6, 80, 'http://taobao.com', 2, 1, NULL, 1540276138, 1540281980);
INSERT INTO `tplay_banner` VALUES (7, 81, 'http://taobao.com', 1, 2, NULL, 1540281644, 1540282015);
...
-- ----------------------------
INSERT INTO `tplay_webconfig` VALUES ('web', '后台管理系统', 'Tplay,后台管理,thinkphp5,layui', 'Tplay是一款基于ThinkPHP5.0.12 + layui2.2.45 + ECharts + Mysql开发的后台管理框架，集成了一般应用所必须的基础性功能，为开发者节省大量的时间。', 1, 'jpg,png,gif,mp4,zip,jpeg', 500, '', '', NULL);
