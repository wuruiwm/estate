...
-- ----------------------------
INSERT INTO `tplay_admin` VALUES (1, 'Tplay', 'admin', '972262e4efe2e00f364d979a7c6ae7ee', 2, 1510885948, 1544087338, 1544241280, '127.0.0.1', 1);
...
-- ----------------------------
INSERT INTO `tplay_admin_cate` VALUES (1, '超级管理员', '4,5,6,7,8,11,13,14,16,17,19,20,21,25,26,28,29,34,35,37,38,39,40,42,43,44,45,47,48,52,53,54,55', 0, 1544254571, '超级管理员，拥有最高权限！');
...
CREATE TABLE `tplay_attachment`  (
  ...
  INDEX `create_time`(`create_time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '附件表' ROW_FORMAT = Dynamic;
