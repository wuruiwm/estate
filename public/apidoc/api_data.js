define({ "api": [
  ...
  },
  {
    ...
    "group": "city",
    "version": "0.1.0",
    "description": "<p>根据当前定位获取的省市区中文名 获取对应id, 参数说明：如果定位为直辖市，则参数 province_name,city_name 直接为直辖市名</p>",
    "sampleRequest": [
      {
        "url": "http://estate.dingdingmaoer.cn/api/v1/city/each_id"
      }
    ],
    "parameter": {
      "fields": {
  ...
  {
    "type": "post",
    "url": "upload/file_imgs",
    "title": "多上传图片",
    "group": "upload",
    "version": "0.1.0",
    "description": "<p>多上传图片</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "city",
            "description": "<p>区县的ID</p>"
          },
          {
            "group": "Parameter",
            "type": "int",
            "optional": false,
            "field": "floor_area_min",
            "description": "<p>面积最小值</p>"
          },
          {
            "group": "Parameter",
            "type": "int",
            "optional": false,
            "field": "floor_area_max",
            "description": "<p>面积最大值</p>"
          },
          {
            "group": "Parameter",
            "type": "int",
  ...
  },
  {
    ...
    "group": "web",
    "version": "0.1.0",
    "description": "<p>获取公告列表</p>",
    "sampleRequest": [
      {
        "url": "http://estate.dingdingmaoer.cn/api/v1/notice/list"
      }
    ],
    "filename": "app/api/controller/v1/Notice.php",
    "groupTitle": "客户端接口",
