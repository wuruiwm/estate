...
class SendSms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIcIe4fkjiuml9"; // AccessKeyId

        $accessKeySecret = "PCk1zuIbXCVYDvuKlArdtM5a9O7plx"; // AccessKeySecret
    ...
    public static function sendSms($phone, $code) {
        ...
        $request->setSignName("刘华超_123456");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_137960036_123456");
...
//
//$response = SendSms::sendSms($phone, $code);
